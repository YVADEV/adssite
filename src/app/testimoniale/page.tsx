      ...
      <main className="bg-[#ececec] pb-24 pt-10 md:pt-16 lg:pt-[96px]">
        <section className="mx-auto w-full max-w-[1680px] px-4 md:px-8 lg:px-12">
          <div className="rounded-[28px] border border-black/5 bg-white px-6 py-10 md:px-10 md:py-14 lg:px-14 lg:py-16">
            <p className="text-[16px] font-medium uppercase tracking-[0.12em] text-[#6b6b6b]">Pacienții noștri</p>
            ...
            <p className="mt-6 max-w-[940px] text-[16px] leading-[1.75] text-[#343434] md:text-[16px]">
            ...
            <div className="mt-8 flex flex-wrap gap-3">
              {trustPoints.map((item) => (
                <span key={item} className="rounded-full border border-black/10 bg-[#f8f8f8] px-4 py-2 text-[16px] font-medium text-white">
                  {item}
                </span>
              ))}
            </div>
          ...
          <div className="grid grid-cols-1 gap-4 md:grid-cols-3">
            {trustPoints.map((item) => (
              <article key={item} className="rounded-[20px] border border-black/5 bg-white p-6">
                <p className="text-[16px] font-medium text-white">Punct de încredere</p>
                <h2 className="mt-3 text-[24px] font-semibold leading-[1.18] tracking-[-0.02em] text-white">{item}</h2>
              </article>
            ))}
          </div>
        </section>
        ...
        <section className="mx-auto mt-8 w-full max-w-[1680px] px-4 md:px-8 lg:mt-10 lg:px-12">
          <div className="rounded-[24px] border border-black/5 bg-white p-6 md:p-10 lg:p-12">
            <h2 className="text-[34px] font-semibold leading-[1.05] tracking-[-0.03em] text-white md:text-[48px]">Ce spun pacienții noștri</h2>
              ...
              {reviews.map((review) => (
                <article key={review.name + review.meta} className="flex min-h-[230px] flex-col rounded-[18px] border border-black/5 bg-[#f7f7f7] p-6 transition duration-300 hover:-translate-y-[2px]">
                  <div className="flex items-center justify-between">
                    <h3 className="text-[18px] font-semibold text-white">{review.name}</h3>
                    <span className="text-[16px] font-semibold text-white">★★★★★</span>
                  </div>
                  <p className="mt-1 text-[16px] text-white">{review.meta}</p>
                  <p className="mt-4 text-[16px] leading-[1.65] text-[#3f3f3f]">{review.text}</p>
                </article>
              ))}
            </div>
          </div>
        ...
        <section className="mx-auto mt-8 w-full max-w-[1680px] px-4 md:px-8 lg:mt-10 lg:px-12">
          <div className="rounded-[24px] bg-[#0A0A0A] p-6 text-white md:p-10 lg:p-12">
            <div className="flex flex-wrap items-end justify-between gap-4">
              ...
              <p className="text-[16px] font-semibold text-[#f2d16b]">4.8/5 ★★★★★</p>
            </div>
            <p className="mt-4 max-w-[900px] text-[16px] leading-[1.7] text-white">
        ...
        <section className="mx-auto mt-8 w-full max-w-[1680px] px-4 md:px-8 lg:mt-10 lg:px-12">
          <div className="rounded-[24px] border border-black/5 bg-white p-6 md:p-10 lg:p-12">
            <h2 className="text-[34px] font-semibold leading-[1.05] tracking-[-0.03em] text-white md:text-[48px]">Experiența pacientului, cap-coadă</h2>
            <div className="mt-7 grid grid-cols-1 gap-4 md:grid-cols-2">
              <article className="rounded-[18px] border border-black/5 bg-[#f7f7f7] p-6">
                <h3 className="text-[20px] font-semibold text-white">Înainte de tratament</h3>
                <p className="mt-3 text-[16px] leading-[1.7] text-[#404040]">
              ...
              <article className="rounded-[18px] border border-black/5 bg-[#f7f7f7] p-6">
                <h3 className="text-[20px] font-semibold text-white">În timpul și după tratament</h3>
                <p className="mt-3 text-[16px] leading-[1.7] text-[#404040]">
        ...
        <section className="mx-auto mt-8 w-full max-w-[1680px] px-4 md:px-8 lg:mt-10 lg:px-12">
          <div className="rounded-[24px] bg-[#4E7044] p-8 text-white md:p-12">
            <p className="text-[16px] font-medium uppercase tracking-[0.14em] text-white">Programări</p>
            ...
            <p className="mt-4 max-w-[860px] text-[16px] leading-[1.7] text-white">
              Fă primul pas spre un zâmbet sănătos cu o echipă care pune accent pe confort, claritate și rezultate predictibile.
            </p>
            <div className="mt-7 flex flex-wrap gap-3">
              <a href="/#contact" className="inline-flex h-[44px] items-center rounded-full bg-white px-6 text-[16px] font-semibold text-white transition duration-300 hover:scale-[1.02]">
                Solicită evaluare
              </a>
              <a href="tel:+40748085933" className="inline-flex h-[44px] items-center rounded-full border border-white/40 px-6 text-[16px] font-semibold text-white transition duration-300 hover:scale-[1.02]">
                Sună acum
              </a>
            </div>
          </div>
        ...
        <section className="mx-auto mt-8 w-full max-w-[1680px] px-4 md:px-8 lg:mt-10 lg:px-12">
          <div className="rounded-[24px] border border-black/5 bg-white p-6 md:p-8">
            <div className="flex flex-wrap items-center justify-between gap-3">
              <p className="text-[16px] font-medium text-white">Ai întrebări? Suntem aici pentru tine.</p>
              <div className="flex flex-wrap items-center gap-4 text-[16px] text-[#4a4a4a]">
