      ...
      <div className="flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
        ...
        <div className="flex shrink-0 gap-2">
          <button
            ...
            className="rounded-full border border-white/25 px-4 py-2 text-[12px] font-semibold text-white transition hover:bg-white/5"
          >
            Doar esențiale
          </button>
          <button
            ...
            className="rounded-full bg-white px-4 py-2 text-[12px] font-semibold text-white transition hover:scale-[1.03]"
          >
            Accept
          </button>
        </div>
