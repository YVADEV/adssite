  ...
  return (
    <html lang="ro" data-theme="dark" className={`${geistSans.variable} antialiased`}>
      ...
      <body className="min-h-screen flex flex-col bg-black text-white">
        <a
          href="#main"
          className="sr-only focus:not-sr-only focus:fixed focus:left-4 focus:top-4 focus:z-[100] focus:rounded-full focus:bg-white focus:px-5 focus:py-2 focus:text-sm focus:font-semibold focus:text-white focus:shadow-lg focus:outline-none focus:ring-2 focus:ring-white"
        >
          Sari la conținut
        </a>
        {children}
