    ...
    <PrototypeFrame>
      <main className="bg-black pb-24 pt-16 text-white md:pt-20 lg:pt-[130px]">
        <section className="mx-auto w-full max-w-[1680px] px-4 md:px-8 lg:px-12">
          <p className="text-[16px] uppercase tracking-[0.14em] text-white">Contact</p>
          <h1 className="mt-4 text-[48px] font-extrabold leading-[0.9] tracking-[-0.05em] md:text-[78px] lg:text-[116px]">
            Contact
          </h1>
          <p className="mt-6 max-w-[1050px] text-[16px] leading-[1.65] text-white md:text-[16px] md:leading-[1.65]">
        ...
        <section className="mx-auto mt-10 w-full max-w-[1680px] px-4 md:px-8 lg:px-12">
          <div className="grid grid-cols-1 gap-4 md:grid-cols-3">
            <article className="rounded-[18px] bg-white p-6 shadow-[0_8px_24px_rgba(0,0,0,0.06)]">
              ...
              <p className="mt-2 text-[16px] leading-[1.6] text-[#4a4a4a]">Vă răspundem cu drag la toate întrebările! Contactați-ne acum!</p>
            </article>
            <article className="rounded-[18px] bg-white p-6 shadow-[0_8px_24px_rgba(0,0,0,0.06)]">
              <p className="text-[22px] font-semibold tracking-[-0.02em]">Programări</p>
              <p className="mt-2 text-[16px] leading-[1.6] text-[#4a4a4a]">Doriți o programare la una dintre clinicile noastre? Completați formularul!</p>
            </article>
            <article className="rounded-[18px] bg-white p-6 shadow-[0_8px_24px_rgba(0,0,0,0.06)]">
              <p className="text-[22px] font-semibold tracking-[-0.02em]">Contact</p>
              <p className="mt-2 text-[16px] leading-[1.6] text-[#4a4a4a]">
        ...
        <section className="mx-auto mt-16 w-full max-w-[1680px] px-4 md:px-8 lg:px-12">
          <div className="flex flex-col gap-3 md:flex-row md:items-end md:justify-between">
            ...
            <p className="max-w-[420px] text-[16px] leading-[1.65] text-white">
          ...
          <div className="mt-8 grid grid-cols-1 gap-4 overflow-hidden rounded-[24px] border border-white/10 bg-white/[0.04] lg:grid-cols-[380px_1fr]">
            <div className="flex flex-col gap-6 p-6 md:p-8">
              <div>
                <p className="text-[16px] uppercase tracking-[0.14em] text-white">Adresă</p>
                <p className="mt-2 text-[16px] font-semibold leading-[1.35] text-white">
                  Alverna Dental Studio
                </p>
                <p className="mt-1 text-[16px] leading-[1.65] text-white">
                  Str. Alverna 33, 400469
                  <br />
                  Cluj-Napoca, România
                </p>
              ...
              <div>
                <p className="text-[16px] uppercase tracking-[0.14em] text-white">Program</p>
                <p className="mt-2 text-[16px] leading-[1.65] text-white">
              ...
              <div>
                <p className="text-[16px] uppercase tracking-[0.14em] text-white">Telefon</p>
                <a
              ...
              <div className="mt-auto flex flex-wrap gap-3 pt-2">
                <a
                  ...
                  className="inline-flex h-[44px] items-center rounded-full bg-white px-5 text-[16px] font-semibold text-white transition duration-300 hover:scale-[1.02]"
                >
                  Deschide ruta
                </a>
                <a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  className="inline-flex h-[44px] items-center rounded-full border border-white/35 bg-white/5 px-5 text-[16px] font-semibold text-white backdrop-blur transition duration-300 hover:bg-white/10"
                >
                  Vezi pe Google Maps
                </a>
              </div>
