    ...
    <main className="bg-[#0A0A0A] pb-24">
      ...
      <section className="mx-auto mt-12 w-full max-w-[1680px] px-4 md:px-8 lg:px-12">
        <motion.div {...reveal} className="rounded-[24px] border border-white/10 bg-white/[0.04] p-6 md:p-10 lg:p-12">
          ...
          <p className="mt-4 max-w-[980px] text-[21px] leading-[1.7] text-white">
        ...
        <motion.div {...reveal} className="rounded-[24px] border border-white/10 bg-white/[0.04] p-6 md:p-10 lg:p-12">
          ...
          <div className="mt-6 grid grid-cols-1 gap-4 md:grid-cols-2">
            {benefitItems.map((item) => (
              <article key={item} className="rounded-[16px] border border-white/10 bg-white/[0.04] p-5 text-[21px] leading-[1.65] text-white">
                {item}
              </article>
            ))}
          </div>
      ...
      <section className="mx-auto mt-8 w-full max-w-[1680px] px-4 md:px-8 lg:px-12">
        ...
        >
          ...
          <p className="relative mt-4 max-w-[820px] text-[21px] leading-[1.7] text-white">
          ...
          <a
            href="/#contact"
            className="relative mt-7 inline-flex h-[46px] items-center rounded-full bg-white px-6 text-[21px] font-semibold text-white transition duration-300 hover:scale-[1.02]"
          >
            Solicită programare
          </a>
        </motion.div>
