    ...
    <main className="bg-[#ececec] pb-24 pt-14 md:pt-20 lg:pt-[130px]">
      <section className="mx-auto w-full max-w-[1680px] px-4 md:px-8 lg:px-12">
        <motion.div {...reveal} className="max-w-[1180px]">
          <p className="text-[12px] font-medium uppercase tracking-[0.13em] text-[#5c5c5c]">Ortodonție invizibilă</p>
          ...
          <p className="mt-7 max-w-[920px] text-[16px] leading-[1.75] text-[#373737] md:text-[17px]">
            Gutiera transparentă Spark este o soluție modernă de ortodonție pentru alinierea dinților, creată pentru pacienții care își doresc un tratament discret, confortabil și predictibil.
          </p>
      ...
      <section className="mx-auto mt-7 w-full max-w-[1680px] px-4 md:px-8 lg:px-12">
        <motion.div {...reveal} className="relative overflow-hidden rounded-[28px]">
          <img src="/spark-hero.png" alt="Aparat dentar Spark transparent" className="h-[56vw] max-h-[700px] min-h-[320px] w-full object-cover saturate-[0.88] brightness-[0.88] transition duration-700 hover:scale-[1.02]" />
          <div className="pointer-events-none absolute inset-0 bg-gradient-to-t from-black/38 via-black/16 to-black/8" />
          <p className="absolute left-5 top-5 rounded-full border border-white/25 bg-black/30 px-4 py-1.5 text-[11px] font-medium uppercase tracking-[0.12em] text-white">Spark Aligners</p>
        </motion.div>
      </section>
      ...
      <section className="mx-auto mt-16 w-full max-w-[1680px] px-4 md:px-8 lg:px-12">
        <motion.article {...reveal} className="grid border-t border-black/12 pt-10 lg:grid-cols-[minmax(260px,0.95fr)_minmax(0,1.55fr)] lg:gap-14">
          <h2 className="text-[32px] font-semibold leading-[1.03] tracking-[-0.03em] text-[#0A0A0A] md:text-[44px]">Ortodonție discretă, fără bracketuri metalice</h2>
          <p className="mt-5 text-[16px] leading-[1.75] text-[#3a3a3a] lg:mt-0">
            Aparatul dentar Spark folosește gutiere transparente realizate digital, concepute pentru a mișca treptat dinții în poziția corectă. Tratamentul este planificat în detaliu, astfel încât pacientul să înțeleagă etapele și rezultatul estimat încă de la început.
          </p>
        </motion.article>
        ...
        <motion.article {...reveal} className="mt-14 grid border-t border-black/12 pt-10 lg:grid-cols-[minmax(260px,0.95fr)_minmax(0,1.55fr)] lg:gap-14">
          <h3 className="text-[30px] font-semibold leading-[1.05] tracking-[-0.028em] text-[#0A0A0A] md:text-[40px]">De ce aleg pacienții Spark?</h3>
      ...
      <section className="mx-auto mt-16 w-full max-w-[1680px] px-4 md:px-8 lg:px-12">
        <motion.div {...reveal} className="relative overflow-hidden rounded-[28px] bg-[#0A0A0A] p-8 text-white md:p-10 lg:p-12">
          ...
          <h3 className="text-[30px] font-semibold leading-[1.05] tracking-[-0.028em] md:text-[40px]">Vrei să afli dacă Spark este potrivit pentru tine?</h3>
          <p className="mt-4 max-w-[820px] text-[16px] leading-[1.7] text-white/82">
            Programează o evaluare ortodontică și primește recomandarea potrivită pentru zâmbetul tău.
          </p>
